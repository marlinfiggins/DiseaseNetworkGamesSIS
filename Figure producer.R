...
ggnet2(net, color=state,palette = c("Infected" = "red", "Susceptible" = "blue", "Recovered"="yellow"), size='degree', label=N, label.size=2, label.color = 'white', mode = "circle") + guides( size=FALSE)
...
net %v% "state" = ifelse(S[,t] %in% c(1), "Infected", "Susceptible")
state=factor(net %v% "state")
ggnet2(net, color=state, palette = c("Infected" = "red", "Susceptible" = "blue"), size='degree', label=JerkLab, label.size=2, label.color = 'white', mode = "circle") + guides( size=FALSE)
